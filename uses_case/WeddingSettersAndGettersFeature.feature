...
Feature: event setters and getters
  ...
  Scenario: name setters and getters
    ...
    Scenario: Officiant setters and getters
    Given Officiant setter is used to change Officiant
    Then Officiant is changed
    And Officiant getter shows the new Officiant
    ...
    Scenario: Wedding_type setters and getters
    Given Wedding_type setter is used to change Wedding_type
    Then Wedding_type is changed
    And Wedding_type getter shows the new Wedding_type
    
    Scenario: DJ setters and getters
    Given DJ setter is used to change DJ
    Then DJ is changed
    And DJ getter shows the new DJ
    
    Scenario: Bride setters and getters
    Given Bride setter is used to change Bride
    Then Bride is changed
    And Bride getter shows the new Bride
    
    Scenario: Groom setters and getters
    Given Groom setter is used to change Groom
    Then Groom is changed
    And Groom getter shows the new Groom
